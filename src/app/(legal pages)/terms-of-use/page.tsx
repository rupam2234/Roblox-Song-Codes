    ...
    <main>
      <div className="p-6 lg:px-[140px]">
        <FeaturedBox
          ...
          descriptionText2={`By using this Website, you agree to these terms and conditions without any changes. This includes all rules, policies, and procedures that Roblox.geekguidez.com may update from time to time.`}
