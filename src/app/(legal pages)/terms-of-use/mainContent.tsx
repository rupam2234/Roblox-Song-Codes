  ...
  return (
    <div className="text-[17px] text-gray-600 space-y-5">
      ...
      <ul className="terms-list space-y-3">
        <li>
          <strong>Follow the Law:</strong> You must comply with all applicable
          laws and regulations while using our website.
        </li>
        <li>
          <strong>Provide Accurate Information:</strong> Make sure the
          information you give us is true and accurate.
        </li>
        <li className="space-y-3">
          <strong>Avoid Prohibited Activities:</strong> You must not:
          <ul className="space-y-3">
            <li>
              Send or share content that is illegal, harmful, threatening,
              abusive, harassing, defamatory, vulgar, obscene, or offensive.
            </li>
            <li>
      ...
      <p>
        ...
        . We will respond to all such notices by removing the infringing
        material or disabling access to it, as appropriate.
      </p>
      <p>
      ...
      <p>
        This Agreement shall be governed by and construed by the laws of India,
      ...
      <p>
        ...
        <a
          ...
          href="mailto:team@geekguidez.com"
          rel="nofollow"
          target="_blank"
        >
          team@geekguidez.com
