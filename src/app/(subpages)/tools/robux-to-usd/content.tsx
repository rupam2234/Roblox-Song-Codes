...
const Content = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <p>
        This table represents Robux equivalent to USD for various amount of USD
        according to DevX current conversion rate:
      </p>
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full border border-gray-400 border-collapse">
          <thead>
            <tr>
              <th className="px-4 py-2 border border-gray-400">Robux Amount</th>
              <th className="px-4 py-2 border border-gray-400">
                USD Equivalent
              </th>
            </tr>
      ...
      <p>
        ...
        result, conversions results will be different.
      </p>
      <p>
